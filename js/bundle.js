...
function cards() {
  ...
  // Якщо нам не потрібна шаблонізація, то можна створити елементи подібним чином:
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2024-04-16');
